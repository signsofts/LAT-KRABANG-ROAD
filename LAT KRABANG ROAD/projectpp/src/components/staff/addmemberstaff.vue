            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" @submit.prevent="submitForm" novalidate>
                    ...
                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" type="submit" style="margin-right: 10px;">สมัครสมาชิก</button>
                        <button class="login100-form-btn" @click="goBack">ย้อนกลับ</button>
                    </div>
...
const goBack = () => {
    // ให้ทำการนำผู้ใช้ไปที่หน้า indexstaff โดยใช้วิธีที่คุณใช้ในการเปลี่ยนหน้า
